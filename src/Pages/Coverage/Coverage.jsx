...
const Coverage = () => {
    ...
    return (
        <div className='bg-white px-24 py-20 rounded-3xl'>
            <div>
                <h2 className='text-5xl font-bold mb-8'>We are available in 64 districts</h2>

                <div className='mb-8 border-b-2 border-base-300 pb-8'>
                ...
                <h2 className='text-3xl font-bold mb-8'>We deliver almost all over Bangladesh</h2>
